...
abstract class BasicAliPay
{
    ...
    public function __construct($options)
    {
        ...
        Url::root('/index.php');
        $this->options['notify_url'] = Url::build('/one_pay/callback/async', ['method' => PAY_CODE], '', true);
        $this->options['return_url'] = Url::build('/one_pay/callback/sync', ['method' => PAY_CODE], '', true);
